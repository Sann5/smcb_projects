...
res50000 = data.frame(C=C,R=R)
head(res50000)

#Print the table
table50000=table(res50000)/niter
table50000
...
freqC<-c()
freqR<-c()
for(i in 1:nrow(res50000)){
  freqC<-append(freqC,sum(res50000$C[1:i])/i)
  freqR<-append(freqR,sum(res50000$R[1:i])/i)
}
...
freqR2<-c()
for(i in 1:nrow(res50000)){
  freqC2<-append(freqC2,sum(res50000$C[1:i])/i)
  freqR2<-append(freqR2,sum(res50000$R[1:i])/i)
}



df <- data.frame(1:nrow(res50000),freqC,freqR,freqC2,freqR2)
ggplot(df, aes(1:nrow(res50000))) +           
