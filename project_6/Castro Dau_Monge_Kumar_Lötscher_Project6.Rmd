...
$$
P (R = T, S = T, W = T)= \sum_{c \in \{F,T\}}P (R = T,C=c, S = T, W = T)=\sum_{c \in \{F,T\}}P(C=c)P(R=T|C=c)P(S=T|C=c)P(W=T|R=T,C=c)\\
...
$$
P(S = T, W = T)={\sum_{c \in \{F,T\}}\sum_{r \in \{F,T\}}P (R = r,C=c, S = T, W = T)}=\sum_{c \in \{F,T\}}P (R = T,C=c, S = T, W = T)+\sum_{c \in \{F,T\}}P (R = F,C=c, S = T, W = T)\\
