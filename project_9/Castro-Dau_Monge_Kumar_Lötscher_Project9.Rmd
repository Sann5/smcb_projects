...
The colliders are preserved for every value of αμ while the rest of the skeleton/structure gets lost for smaller values of αμ, where we observe a sparse network with several disconnected components.
